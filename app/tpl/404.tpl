...
<h1>:(</h1>
<p class="title">页面错误！请稍后再试~</p>

<p class="detail" ng-bind="detail"></p>
<p class="jump"><a href="#/">返回首页</a></p>
<p class="jump" ng-if="$location.$$search.path">
页面自动 <a ng-route="$location.$$search.path">跳转</a> 等待时间： <b ng-bind="waitSecond"></b>
</p>
</div>
<template data-path="'888'"></template>
</code>
<style>
*{ padding: 0; margin: 0; }
...
.system-message .title{ line-height: 1.8em; font-size: 36px }
